 ...
 */
const { initAuthCreds, BufferJSON, proto } = (await import('@shizodevs/shizoweb')).default

/**
 * @param {import('@shizodevs/shizoweb').WASocket | import('@shizodevs/shizoweb').WALegacySocket}
 */
function bind(conn) {
  if (!conn.chats) conn.chats = {}
  /**
   *
   * @param {import('@shizodevs/shizoweb').Contact[]|{contacts:import('@shizodevs/shizoweb').Contact[]}} contacts
   * @returns
   */
